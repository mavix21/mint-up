...
import { YStack, XStack, SizableText, Button, Tabs, FullscreenSpinner, Separator } from '@my/ui';
...
export const ManageEventScreen = ({ id }: { id: string }) => {
  ...
  return (
    <YStack height="100%" maxWidth={800} marginInline="auto" backgroundColor="$background">
      {/* Header */}
